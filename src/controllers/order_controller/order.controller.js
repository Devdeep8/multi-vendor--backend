...
const notificationController = require("../notification_controller/notification.controller");
...
const OrderController = {
  ...
  async create(req, res) {
    ...
    try {
      ...
      try {
        ...
        await notificationController.sendOrderNotifications(order, user);
      } catch (error) {
  ...
  try {
    ...
    console.log(order_status, payment_status, id);
    const order = await db.Order.findOne({
      where: {
        id: id, // assuming `id` is the order number passed in the request
      },
    });
    console.log(order);
    if (!order) {
    ...
    try {
      await notificationController.sendOrderStatusUpdateNotifications(order);
    } catch (error) {
